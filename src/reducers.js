...
const img = (src, alt, width = 250) => {
  const img = new Image(width, 250);
  img.alt = alt;
...
export const filters = {
  1: {
    ...
    img: img('petits.cadeaux', 'Petits cadeaux'),
  },
  2: {
    name: 'Double|Face',
    ...
    img: img('double.face', 'Double face'),
  },
  3: {
    name: 'Alibi|Vert',
  ...
  4: {
    ...
    icon: 'ico_fauteuil',
    img: img('place.libre', 'Place libre'),
  },
  5: {
    ...
    img: img('macron.compatibilite', 'Macron-Compatible'),
  },
  6: {
    name: '100%|Salades',
    ...
    icon: 'ico_salade',
    img: img('100.salade', '100% Salades'),
  },
  7: {
    name: 'Le coin des|affaires',
    description: "En matière d'exemplarité, la politique c'est souvent de belles promesses et de la poudre de perlimpinpin. Certains candidats investis par La République en marche sembleraient s'être pris les pieds dans le tapis…",
    icon: 'ico_affaires',
    img: img('affaires', 'Le coin des affaires', 300),
  },
  8: {
    name: 'Coup|De Bluff',
    ...
    icon: 'ico_bluff',
    img: img('coup.bluff', 'Coup de bluff'),
  },
};
