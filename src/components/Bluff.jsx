    ...
    <Container>
      <Row>
        <Col md={6} offset={{ md: 1 }}>
          <article>
            <p>Le 11 mai 2017, Richard Ferrand a présenté une première liste de 428 candidats estampillés La République en marche dont 52% de candidats issus de la société civile.</p>
